...
const translations = {
  ...
  en: {
    ...
    emailCopied: 'Copied!',
    resumeLabel: 'Resume / Experience',
    resumePlaceholder: 'More content coming soon…',
  }
};
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.card}>
        <span className={styles.cardLabel}>{t.resumeLabel}</span>
        ...
        <div className={styles.cardContent}>
          ...
          <h2 className={styles.cardName}>Rain</h2>
